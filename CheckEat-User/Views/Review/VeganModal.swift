...
struct VeganModal: View {
    ...
    var body: some View {
        VStack(alignment: .leading) {
            Text("vegan_modal_title")
                .bold20()
                .padding(.top, 10)
            Text("vegan_modal_subtitle")
                .padding(.top, 10)
            Text("vegan_type_vegan")
                .padding(.vertical, 6)
